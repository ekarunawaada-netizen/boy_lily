...
const { getMemberDetail, getAllMembers, getBirthdayMembers} = require("./modules/member");
const { getLive, getRecentLive, getIdn, getShowroom } = require("./modules/live");
const { createPayment, checkPaymentStatus } = require("./modules/payment");
const { getNews, getNewsDetail } = require("./modules/news"); 
...
const { getYoutube } = require("./modules/youtube"); 
...
if (require.main === module) {
  ...
  if (!command || !apiKey) {
    ...
    console.error(
      "Commands: check, theater, events, eventDetail, theaterDetail, memberDetail, Birthday, Brat, Tiktok, allMembers, live, IdnLive, ShowroomLive, recentLive, createPayment, checkPaymentStatus, news, newsDetail, Youtube"
    );
    process.exit(1);
  }
